...
//	  vector<int> y = { 8,5,2,1,7,1};
    ...
    y_b.sgn = y_s;
    BadicRepresentation<B> z_b = FundamentalMultiply(x_b, y_b);
    ...
    cout << "X*Y in 2-adischer Darstellung (FundamentalMultiply): " << FundamentalMultiply(x_new, y_new) << endl;
    cout << endl;

    BadicRepresentation<2> z_new = FastMultiply(x_b, y_b);
